...
export default function Detailpage() {
    ...
    return (
        <div className="min-h-25 flex flex-col   text-black p-10">
            ...
            {/* Contact Section */}
            {constructorDetail.Contact && (
                <div className="text-xl mb-6">
                    <a href={`tel:${constructorDetail.Contact}`} className="text-gray-300 hover:text-white">
                        <div className="flex gap-2 items-center">
                            <object className='w-6 h-6' type="image/svg+xml" data="/logos/call.svg" >
                            </object>
                            <span className='text-black'>{constructorDetail.Contact}</span>
                        </div>
                    </a>
                </div>
            )}
