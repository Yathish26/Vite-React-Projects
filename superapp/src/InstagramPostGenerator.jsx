        ...
        <>
            <div className='min-h-screen w-screen flex justify-center items-center bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]'>
                <div className={`flex ${theme}`}>
                    <div className=' border-8 w-fit h-fit rounded-md'>
                            ...
                            <div className='w-96 px-4 py-2'>
                                <div className='flex justify-between pb-3'>
                                    <div className='flex gap-4'>
                                        ...
                                        <svg className='dark:stroke-white cursor-pointer stroke-black' aria-label="Comment" fill="currentColor" role="img" width="24" height="24" viewBox="0 0 24 24"><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill='none' stroke-linejoin="round" stroke-width="2"></path></svg>
                                        <svg className='dark:stroke-white cursor-pointer stroke-black' aria-label="Share Post" fill="currentColor" role="img" width="24" height="24" viewBox="0 0 24 24"><line fill="none" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line><polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke-linejoin="round" stroke-width="2"></polygon></svg>
                                    </div>
                                    <svg className='dark:stroke-white cursor-pointer stroke-black' aria-label="Save" fill="currentColor" role="img" width="24" height="24" viewBox="0 0 24 24"><title>Save</title><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
                                </div>
                    ...
                    {/* Controls Section */}
                    <div className='ml-4 w-full max-w-lg mx-auto bg-white border rounded-lg shadow-lg p-6'>
                        ...
                        <div className='flex mb-6 space-x-4'>
                            ...
                            {/* <div className='flex flex-col'>
                                ...
                                <select name="" id="" className='border border-gray-300 px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500'>
