...
export default function Journey() {
    ...
    return (
        <div style={{
            ...
            <Arrow />
            <SkillSet ref={addToRefs} logo={'django'} name={'Django'} list={django} listhead={'Django Projects'} description={'A Modern Dynamic Web Framework'} />
            <Arrow />

            {/* JavaScript Section */}
            <div ref={addToRefs} className="flex flex-col items-center justify-center space-y-4 mt-12 transition-opacity duration-500 ease-in-out hover:opacity-90">
                <img src="/skillcon/javascript.svg" alt="JavaScript" className="w-20 h-20 md:w-24 md:h-24 transition-transform transform-gpu hover:scale-110" />
                <div className="flex flex-col text-center">
            ...
            {/* Other Skill Sets */}
            <Arrow />
            <SkillSet ref={addToRefs} logo={'css'} name={'CSS'} list={css} listhead={'Exploring CSS'} description={'Yep, CSS is Very Deep'} />
            <Arrow />
            <SkillSet ref={addToRefs} logo={'react'} name={'React JS'} list={reactjs} listhead={'React Projects'} description={'A JavaScript Library'} />
            <Arrow />
            <SkillSet ref={addToRefs} logo={'djangorest'} name={'Django REST'} list={rest} listhead={"REST API's"} description={"Python Framework for Building Web APIs"} />
            <Arrow />
            <SkillSet ref={addToRefs} logo={'nodejs'} name={'Node JS'} list={nodejs} listhead={'Minimal Node Projects'} description={'JavaScript Runtime Environment'} />
            <Arrow />
            <SkillSet ref={addToRefs} logo={'tailwind'} name={'Tailwind'} list={tailwind} listhead={'My Current Favourite'} description={'CSS Framework'} />
        </div>
    );
}
